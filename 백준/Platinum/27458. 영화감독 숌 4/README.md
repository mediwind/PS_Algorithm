# [Platinum V] 영화감독 숌 4 - 27458 

[문제 링크](https://www.acmicpc.net/problem/27458) 
...
<p>숌이 만든 영화의 제목에 들어간 수가 입력으로 주어진다. 이 영화는 숌이 몇 번째로 만든 영화인지 출력하는 프로그램을 작성하시오. 숌은 이 시리즈를 항상 차례대로 만들고, 다른 영화는 만들지 않는다.</p>

### 입력 

 <p>첫째 줄에 영화의 제목에 들어간 수가 주어진다. 이 수는 10<sup>18</sup>보다 작거나 같은 자연수이며, 종말의 수이다.</p>

### 출력 

 <p>첫째 줄에 입력으로 주어진 영화가 몇 번째 영화인지 출력한다.</p>
