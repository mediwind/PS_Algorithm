# [Gold III] Spaceship Defence (Small) - 12284 

[문제 링크](https://www.acmicpc.net/problem/12284) 

### 성능 요약

메모리: 40168 KB, 시간: 712 ms

### 분류

구현, 그래프 이론, 자료 구조, 집합과 맵, 최단 경로, 해시를 사용한 집합과 맵, 데이크스트라, 분리 집합

### 제출 일자

2025년 11월 12일 21:02:59
...
<p>You will be given the locations and destinations of several soldiers. For each soldier, output the minimum amount of time it could take that soldier to travel from his location to his destination.</p>
